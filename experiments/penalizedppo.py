...
env_cfg = dict(safety_factor=.1, vol_init=np.random.uniform, vol_max=10, penalty=0, steps_max=1000)
...
model = PenalizedPPO('MlpPolicy', env, penalty=SimplePenalty(env), penalty_coef=0, verbose=1,
